...
def dashboard():
    ...
    doughnut_abouties = total_interactions_abouties[0][0]/(total_interactions_abouties[0][0] + total_interactions[0][0])
    doughnut_non_abouties = (total_interactions[0][0] - total_interactions_abouties[0][0])/(total_interactions_abouties[0][0] + total_interactions[0][0])
...
def addAvis():
    ...
    id_util = Utilisateur.query.filter_by( numero_telephone = donnee['conversation']['memory']['numero_telephone']).first().id
